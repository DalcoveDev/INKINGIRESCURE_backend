...
exports.ReportStatusHistoryService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const report_status_history_entity_1 = require("./entities/report-status-history.entity");
let ReportStatusHistoryService = class ReportStatusHistoryService {
    reportStatusHistoryRepository;
    constructor(reportStatusHistoryRepository) {
...
exports.ReportStatusHistoryService = ReportStatusHistoryService;
exports.ReportStatusHistoryService = ReportStatusHistoryService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(report_status_history_entity_1.ReportStatusHistory)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ReportStatusHistoryService);
//# sourceMappingURL=report-status-history.service.js.map