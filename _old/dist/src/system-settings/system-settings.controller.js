...
const create_system_setting_dto_1 = require("./dto/create-system-setting.dto");
const update_system_setting_dto_1 = require("./dto/update-system-setting.dto");
let SystemSettingsController = class SystemSettingsController {
    systemSettingsService;
    constructor(systemSettingsService) {
        this.systemSettingsService = systemSettingsService;
    }
    create(createSystemSettingDto) {
    ...
    update(id, updateSystemSettingDto) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [create_system_setting_dto_1.CreateSystemSettingDto]),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, update_system_setting_dto_1.UpdateSystemSettingDto]),
    __metadata("design:returntype", void 0)
