...
exports.ResponderProfilesService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const responder_profile_entity_1 = require("./entities/responder-profile.entity");
let ResponderProfilesService = class ResponderProfilesService {
    responderProfilesRepository;
    constructor(responderProfilesRepository) {
        this.responderProfilesRepository = responderProfilesRepository;
    }
...
exports.ResponderProfilesService = ResponderProfilesService;
exports.ResponderProfilesService = ResponderProfilesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(responder_profile_entity_1.ResponderProfile)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], ResponderProfilesService);
//# sourceMappingURL=responder-profiles.service.js.map